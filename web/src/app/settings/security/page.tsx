    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>End this browser session and return to the login screen.</CardDescription>
        </CardHeader>
        <CardContent>
          <LogoutButton className="inline-flex h-9 items-center gap-2 border border-zinc-700 px-3 font-mono text-sm text-zinc-200 hover:border-amber-500 hover:text-amber-300 disabled:opacity-50" />
        </CardContent>
      </Card>
    </div>
  );
