...
function Card({ item }: { item: RecentlyAddedItem }) {
  ...
  return (
    <figure className="flex w-[150px] shrink-0 flex-col overflow-hidden rounded-xl bg-zinc-900/80 border border-zinc-700/50 backdrop-blur-sm">
    ...
    <div className="mt-8">
      ...
      {data.error ? (
        <p className="text-sm text-zinc-500">{data.error}</p>
          ...
          <div className="recently-added-scroll min-h-[300px] overflow-x-auto vision-card-secondary p-5">
