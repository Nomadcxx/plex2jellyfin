...
func runConsolidateGenerate() error {
	...
	fmt.Println("\nNext steps:")
	fmt.Println("  plex2jellyfin consolidate dry-run   # Preview moves")
	fmt.Println("  plex2jellyfin consolidate execute   # Execute moves")
...
func runConsolidateDryRun() error {
	...
	if plan == nil {
		...
		fmt.Println("Run 'plex2jellyfin consolidate generate' first to create plans.")
		return nil
	}
	...
	if hasSafetyIssues {
		...
		fmt.Println("To execute: plex2jellyfin consolidate execute")
	}
	return nil
}
