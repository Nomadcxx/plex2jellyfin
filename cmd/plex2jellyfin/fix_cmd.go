...
import (
	...
	"github.com/Nomadcxx/plex2jellyfin/internal/wizard"
...
Examples:
  plex2jellyfin fix                    # Full interactive wizard
  plex2jellyfin fix --dry-run          # Preview what would happen
  plex2jellyfin fix --yes              # Auto-accept all suggestions
  plex2jellyfin fix --duplicates-only  # Only handle duplicates
`,
